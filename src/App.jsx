...
function App() {
  ...
  const handleRemovePlace = useCallback(async function handleRemovePlace() {
    ...
    try{
      ...
      setUserPlaces(userPlaces)
      setErrorupdate({message: error.message || 'Failed to delete place'})
    }
  ...
  return (
    <>
      <Modal open={errorupdate} onClose={handleError}>
        {errorupdate && <Error title='An error occured' message={setErrorupdate.message} onConfirm={handleError}/>}
      </Modal>
